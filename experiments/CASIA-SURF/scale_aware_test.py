...
if __name__ == '__main__':
    ...
    for i in range(8):
        ...
        pretrain_dir = "../output/models/surf_patch_kd_multikd_avg_multi_multi_rgb_lr_0.001_version_" + str(
            i) + "_lambda_kd_0.8_select_1_acer_best_.pth"
        #
        # pretrain_dir = "../output/models/surf_patch_kd_multikd_max_multi_multi_rgb_lr_0.001_version_2_weight_patch_0_select_0.pth"
