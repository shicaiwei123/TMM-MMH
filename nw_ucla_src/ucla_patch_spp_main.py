...
def deeppix_main(args):
    train_dataset = nw_ucla.NWUCLA_CS(data_root=args.data_root,
    ...
    test_dataset = nw_ucla.NWUCLA_CS(data_root=args.data_root,
                                     split_subject=args.split_subject,
                                     clip_len=args.clip_len,
                                     mode='rgb',
                                     train=False,
    ...
    if args.init_mode == 'kinects':
        student_model = i3_res50_spp(400, "/home/icml/shicaiwei/pytorch-resnet3d/pretrained/i3d_r50_kinetics.pth")
