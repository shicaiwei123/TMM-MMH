...
parser.add_argument('--method', type=str, default='patch_kd_multikd_avg_attention')
...
args.name = args.dataset + "_" + args.method + "_" + args.teacher_data + "_" + args.student_data + "_lr_" + str(
    ...
    args.version) + '_lambda_kd_' + str(args.lambda_kd) + '_weight_patch_' + str(args.weight_patch)
