...
parser.add_argument('--method', type=str, default='multi_depth_kd_random_init')
...
parser.add_argument('--student_modal', type=str, default='depth', help='the origin modal to train the student ')
parser.add_argument('--student_data', type=str, default='multi_rgb',
                    help='the data to trained the student modal: multi_rgb,multi_ir,multi_depth,single_rgb,single_depth,single_ir')
...
parser.add_argument('--T', type=float, default=3.0, help='temperature for ST')
...
parser.add_argument('logits_kd', type=int, default=1)
parser.add_argument('feature_kd', type=int, default=0)
parser.add_argument('version', type=int, default=1)

args = parser.parse_args()
# args.model_root = args.model_root + '/' + args.method
# args.log_root = args.log_root + '/' + args.method

args.name = args.method + '_' + args.teacher_data + "_" + args.student_data + "_lr_" + str(
    args.lr) + "_logits_kd_" + str(args.logits_kd) + "_feature_kd_" + str(args.feature_kd) + '_version_' + str(
    args.version)
