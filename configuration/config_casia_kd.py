...
parser.add_argument('--method', type=str, default='patch_kd_mmd_max_avg')
...
parser.add_argument('--test_dir', type=str,
                    default='/home/bbb/shicaiwei/data/liveness_data/CASIA-FASD/CASIA-FASD_face_landmarks/test')
...
args.name = args.method + "_" + args.teacher_data + "_" + args.student_data + "_lr_" + str(args.lr) + '_version_' + str(
    args.version) + '_sift_' + str(args.sift)
os.environ['CUDA_VISIBLE_DEVICES'] = str(args.gpu)
args.weight_patch = False
args.sample_interal=1
