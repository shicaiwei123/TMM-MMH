...
parser.add_argument('--rgb_root', type=str,
                    default='/home/bbb/shicaiwei/data/liveness_data/CASIA-SURF/Single/color/Testing')
parser.add_argument('--ir_root', type=str,
                    default='/home/bbb/shicaiwei/data/liveness_data/CASIA-SURF/Single/color2ir/Testing')
parser.add_argument('--depth_root', type=str,
                    default='/home/bbb/shicaiwei/data/liveness_data/CASIA-SURF/Single/color2depth/Testing')
