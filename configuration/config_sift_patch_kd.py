...
parser.add_argument('--method', type=str, default='sift_patch_kd_bce_kl_max_avg')
...
parser.add_argument('--T', type=float, default=1.0, help='temperature for ST')
...
parser.add_argument('--cluster_num', type=int, default=16,)
