...
parser.add_argument('--method', type=str, default='CDD_CV_val_all')
...
parser.add_argument('--kd_mode', type=str, default='logits', help='mode of kd, which can be:'
...
parser.add_argument('rgb_pretrain_path', type=str,
                    default="/home/icml//shicaiwei/pytorch-resnet3d/src/cv/tmp/rgb/3/8/ckpt_clip3_E_254_I_2.pth")
parser.add_argument('depth_pretrain_path', type=str,
                    default="/home/icml//shicaiwei/pytorch-resnet3d/src/cv/tmp/depth/3/8/ckpt_clip3_E_227_I_2.pth")
...
args.name = args.method + "_" + "_lr_" + str(args.lr) + '_version_' + str(args.version)
os.environ['CUDA_VISIBLE_DEVICES'] = str(args.gpu)

split_num = int(args.rgb_pretrain_path.split('/')[-3])
