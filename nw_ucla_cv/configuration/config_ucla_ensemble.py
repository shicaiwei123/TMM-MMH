...
parser.add_argument('--method', type=str, default='spp_ensemble_cd_cv_video')
...
parser.add_argument('spp_pretrained_dir', type=str,
                    default="/home/icml//shicaiwei/multi_model_fas/output/models/multiKD/_ckpt_E_290_I_0.pth")
parser.add_argument('cd_pretrained_dir', type=str,
                    default="/home/icml/shicaiwei/multi_model_fas/output/models/ckpt_E_224_I_1.pth")
