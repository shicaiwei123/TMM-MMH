...
parser.add_argument('--method', type=str, default='multiKD_CV_lambda_kd_avg')
...
parser.add_argument('weight_patch', type=int, default=0, help='weight for different patch')
