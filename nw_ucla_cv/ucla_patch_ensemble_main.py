...
def deeppix_main(args):
    if args.mode == 'video':
        nwucla_trainset = nw_ucla.NWUCLACV_MultiCrop(data_root="/home/data/shicaiwei/N-UCLA/multiview_action",
        ...
        nwucla_trainset = nw_ucla.NWUCLA_CV(data_root="/home/data/shicaiwei/N-UCLA/multiview_action",
                                            split_num=args.split_num,
                                            clip_len=args.clip_len,
                                            mode='rgb',
                                            train=True,
    ...
    trainloader = torch.utils.data.DataLoader(nwucla_trainset, batch_size=args.batch_size, shuffle=False,
