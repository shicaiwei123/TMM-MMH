...
from configuration.config_patch_kd_attention import args
...
def deeppix_main(args):
    ...
    train_knowledge_distill_patch(net_dict=nets, cost_dict=criterions, optimizer=optimizer, train_loader=train_loader,
