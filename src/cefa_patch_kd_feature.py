...
from loss.kd import *
from lib.model_develop import train_knowledge_distill_patch_feature_cefa
...
def deeppix_main(args):
    ...
    train_knowledge_distill_patch_feature_cefa(net_dict=nets, cost_dict=criterions, optimizer=optimizer, train_loader=train_loader,
