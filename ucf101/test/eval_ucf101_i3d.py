...
if __name__ == '__main__':
    ...
    os.environ['CUDA_VISIBLE_DEVICES'] = str(1)
    # pretrain_dir = "../results/ucf101_0.01/0/rgb/16/ckpt_E_94_I_1.pth"
    pretrain_dir = "../results/ucf101_0.01/0/all/kinects/lambda_kd_0.25/_ckpt_E_22_I_2.pth"
    ...
    if args.clip == 'video':
        nwucla_testset = ucf101.UCF101_Multicrop(data_root="/home/ssd/video_action/ucf101/rawframes_resize",
    ...
    net = i3dpt_spp.I3D_SPP(101, modality='rgb')
