...
parser.add_argument('--method', type=str, default='mars')
...
parser.add_argument('--lambda_kd', type=float, default=50.0, help='trade-off parameter for kd loss')
...
parser.add_argument('--teacher_data', type=str, default='flow')
parser.add_argument('--student_data', type=str, default='rgb')
parser.add_argument('--weight_patch', default=0)
parser.add_argument('gpu', type=int, default=0)
parser.add_argument('version', type=int, default=0)
parser.add_argument('lr_warmup', type=int, default=0)

args = parser.parse_args()
# args.method = 'single_to_single_' + args.method
args.pair_modalities = [args.teacher_data, args.student_data]
